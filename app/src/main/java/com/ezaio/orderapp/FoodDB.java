...
public class FoodDB {
    ...
    public ArrayList<PopularFoodData> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PopularFoodData> playerList =  new ArrayList<PopularFoodData>();

        for(String jObjString : objStrings){
            PopularFoodData player  = gson.fromJson(jObjString,  PopularFoodData.class);
    ...
    public void putListObject(String key, ArrayList<PopularFoodData> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(PopularFoodData player: playerList){
